...
?>
                ...
                <div class="container p60">
                    <section class="row <?php echo 'valign-' . esc_attr($valign); ?>">
                        ...
                        <div class="col-sm-12 col-md-6 feature-split__content">
                            ...
                            <?php if ($copy) : echo wp_kses_post($copy);
                            endif; ?>
                            <?php if ($cta) :
        ...
        * =====================================================*/
        ...
        /* =======================================================
         *  LAYOUT 5 – FEATURE CARDS GRID
        * =====================================================*/
        if (get_row_layout() === 'feature_cards_grid') :
            ...
            $overlay  = $bg['overlay_color']     ?? '';
            $opacity  = ($bg['overlay_opacity'] ?? 0) / 100;
            $text_col = $bg['text_color']        ?? '';

            /* ---- style / classes ---- */
            $style = '';
            $class = 'feature-split feature-cards-band text-' . esc_attr($align);

            if ($text_col) $style .= "--text-color:$text_col;";
            if ($overlay) $style .= "--overlay-color:$overlay;--overlay-opacity:$opacity;";
        ...
        ?>
            <div class="container-fw <?php echo esc_attr($class); ?>"
                ...
                <div class="container p60">
                    <div class="feature-cards columns-<?php echo (int) $cols; ?>">
                        <?php foreach ($cards as $card) :
                            $icon = chi_media_array($card['icon'] ?? '');
                            $link = $card['card_link'] ?? false; ?>
                            <div class="feature-card">
                                <?php if ($icon) : ?>
                                    <img class="feature-card__icon" src="<?php echo esc_url($icon['url']); ?>" alt="">
                                <?php endif; ?>
                                ...
                                <?php if ($link) :
                                    echo '<a class="btn infinity-btn" href="' . esc_url($link['url']) . '">' .
