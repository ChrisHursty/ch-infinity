        ...
        <div class="row">
            <div class="col-md-6 hero-content">
                ...
                <div class="social-proof">
                    <?php 
                    $social_proof_image = get_field('social_proof_image');
                    if ($social_proof_image) {
                        $image_url = $social_proof_image['url'];
                        $alt_text = !empty($social_proof_image['alt']) ? $social_proof_image['alt'] : 'Hundreds of happy customer'; 
...
<section class="container-fw problem-container dark-bg">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 problem-content">
                <?php 
